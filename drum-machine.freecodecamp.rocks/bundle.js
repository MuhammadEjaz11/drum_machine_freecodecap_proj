! function() {
    ...
    function t(e, t) {
        for (var r = 0; r < t.length; r++) {
            var a = t[r];
            a.enumerable = a.enumerable || !1, a.configurable = !0, "value" in a && (a.writable = !0), Object.defineProperty(e, (o = a.key, n = void 0, "symbol" == typeof(n = function(e, t) {
    ...
    function r(e, r, a) {
        return r && t(e.prototype, r), a && t(e, a), Object.defineProperty(e, "prototype", {
            writable: !1
        }), e
    }
    ...
    var l = [{
        ...
        m = function(t) {
            ...
            function n(t) {
                var r;
                return e(this, n), (r = o.call(this, t)).state = {
                    padStyle: u
                }, r.playSound = r.playSound.bind(i(r)), r.handleKeyPress = r.handleKeyPress.bind(i(r)), r.activatePad = r.activatePad.bind(i(r)), r
            }
            return r(n, [{
                ...
                value: function() {
                    ...
                    t.currentTime = 0, t.play(), this.activatePad(), setTimeout((function() {
                        return e.activatePad()
                    }), 100), this.props.updateDisplay(this.props.clipId.replace(/-/g, " "))
                }
            }, {
                key: "render",
                value: function() {
        ...
        h = function(t) {
            ...
            function n(t) {
                ...
                return e(this, n), (r = o.call(this, t)).state = {
                    ...
                    sliderVal: .3
                }, r.displayClipName = r.displayClipName.bind(i(r)), r.selectBank = r.selectBank.bind(i(r)), r.adjustVolume = r.adjustVolume.bind(i(r)), r.powerControl = r.powerControl.bind(i(r)), r.clearDisplay = r.clearDisplay.bind(i(r)), r
            }
            return r(n, [{
                key: "powerControl",
                value: function() {
